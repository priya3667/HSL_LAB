<header class="sticky top-0 z-40 flex items-center justify-between py-4 md:py-6 mb-8 bg-[#F9FEFF]/80 backdrop-blur-md -mx-4 md:-mx-8 px-4 md:px-8 border-b border-slate-100/50">
    ...
    <div class="flex items-center gap-2 md:gap-4">
        ...
        <div class="relative block border border-[#C5C4C4] rounded-full">
            ...
            <input type="text" placeholder="Search" class="pl-8 md:pl-10 pr-4 py-1.5 md:py-2 bg-white rounded-full focus:outline-none w-28 sm:w-40 md:w-64 font-['Mulish'] font-medium text-[10px] md:text-[12px] leading-none text-[#C5C4C4] placeholder:text-[#C5C4C4]">
        </div>
